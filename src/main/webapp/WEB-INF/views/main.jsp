		...
		<div class="input-group search_container">
			...
			<form class="col" id='searchForm' action="/board/main" method='get'>
				...
				<input type='text' name='keyword'
					...
					type='hidden' name='type' value='TC'>
				<!-- 검색조건 -->
			...
			<div class="mainContent_categoryWrapper">
				<div class="findMyPosition_selectWrapper">
					<div class=" css-container">
						<span aria-live="polite" aria-atomic="false" aria-relevant="additions text" class="css-Text"></span> 
						<select id="position" class="form-select form-select-lg mb-4" aria-label=".form-select-lg example" style="font-size: 1.125rem; padding-top: 0.4rem; padding-bottom: 0.4rem;">
