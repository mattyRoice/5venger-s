			...
			<div class="form-group">
				...
				<ul class="nav nav-pills nav-fill mb-3" id="pills-tab" role="tablist">
				  <li class="nav-item" role="presentation">
				    <button class="btn nav-link" id="pills-idpw-tab" data-bs-toggle="pill" data-bs-target="#pills-idpw" type="button" role="tab" aria-controls="pills-home" aria-selected="true">1단계</button>
				  </li>
				  <li class="nav-item" role="presentation">
				    <button class="btn nav-link" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">2단계</button>
				  </li>
				  <li class="nav-item" role="presentation">
				    <button class="btn nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">3단계</button>
				  </li>
				  <li class="nav-item" role="presentation">
				    <button class="btn nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">4단계</button>
				  </li>	  
				</ul>
				
				<div class="tab-content" id="pills-tabContent">
				<!-- 1단계 -->
				  <div class="tab-pane fade show active" id="pills-idpw" role="tabpanel" aria-labelledby="pills-idpw-tab" tabindex="0">				  	
				  	<div class="text-center fs-4 fw-bolder mt-5 mb-5">스터디허브에 처음 오셨군요!<br>우선, 사용하실 아이디와 비밀번호를 입력해주세요.</div>
				  	<input class="form-control form-control-lg mb-1" type="text" id="uid" onchange="checkId()" name="uidKey" placeholder="아이디를 입력하세요." aria-label=".form-control-lg example">
				  	<!-- id ajax 체크 -->
				  	<p id="checkId" class="fw-bold fs-5" style="color:#ff914d"></p>
				  	<div class="text-center mt-5">	
					  	<button type="button" id="to2step" class="btn me-2" style="border-color:#ff914d; color:#ff914d">다음</button>
						<button type="button" id="backmain"class="btn btn-outline-secondary">돌아가기</button><!-- 메인으로 돌아갈것 -->
					</div>				  				  											
				  </div>
				<!-- 2단계 -->  
				  <div class="tab-pane fade" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">				  	
				  	<div class="text-center fs-4 fw-bolder mt-5 mb-5">스터디허브에서 사용하실 닉네임을 설정해주세요.</div>
				  	...
				  	<div class="text-center mt-5">	
						...
						<button type="button" id="back2step"class="btn btn-outline-secondary">돌아가기</button>
					</div>				  				  											
				  </div>
				<!-- 3단계 -->  
				  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
					...
					<div class="text-center mt-5">		
					  	<button type="button" id="to4step" class="btn me-2" style="border-color:#ff914d; color:#ff914d">다음</button>
						<button type="button" id="back2step" class="btn btn-outline-secondary">돌아가기</button>
					</div>				  					  	
				  </div>
				 <!-- 4단계 --> 
				  <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
					...
					<!-- 프로필 이미지 선택 -->
				  	...
				  	<div class="text-center">		
						...
						<button type="button" id="back3step" class="btn btn-outline-secondary mt-5">돌아가기</button>
					</div>				 
				  </div>
